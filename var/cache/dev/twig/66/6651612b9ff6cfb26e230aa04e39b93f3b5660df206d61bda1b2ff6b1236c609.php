...
class __TwigTemplate_053e17ea29c8a1124a529a1067cd8574002f8e9e83811866cb4194c3bf959192 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  101 => 39,  92 => 33,  83 => 27,  74 => 21,  65 => 15,  57 => 10,  53 => 9,  44 => 3,  40 => 1,);
    }
    ...
    <ul class=\"nav nav-pills flex-column mb-auto\">
        <li class=\"nav-item\">
            <a href=\"{{ path('app_app_index') }}\" class=\"nav-link active\" aria-current=\"page\">
        ...
        <li>
            <a href=\"{{ path('author_index') }}\" class=\"nav-link text-white\">
                <svg class=\"bi me-2\" width=\"16\" height=\"16\"><use xlink:href=\"#table\"/></svg>
                Authors
            </a>
        </li>
        <li>
            <a href=\"{{ path('category_index') }}\" class=\"nav-link text-white\">
                <svg class=\"bi me-2\" width=\"16\" height=\"16\"><use xlink:href=\"#table\"/></svg>
                Categories
            </a>
        </li>
        <li>
            <a href=\"{{ path('comment_index') }}\" class=\"nav-link text-white\">
                <svg class=\"bi me-2\" width=\"16\" height=\"16\"><use xlink:href=\"#table\"/></svg>
                Comments
            </a>
        </li>

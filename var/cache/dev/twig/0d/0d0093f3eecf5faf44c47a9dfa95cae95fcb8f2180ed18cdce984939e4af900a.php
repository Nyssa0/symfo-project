...
class __TwigTemplate_72c8b88923016a37a5cf47626a57ef89cfa5530e78aac39082ea49753a279702 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["comment"]) {
            ...
            echo "</td>
                <td>";
            // line 22
            ((twig_get_attribute($this->env, $this->source, $context["comment"], "PostedAt", [], "any", false, false, false, 22)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["comment"], "PostedAt", [], "any", false, false, false, 22), "Y-m-d H:i:s"), "html", null, true))) : (print ("")));
            echo "</td>
                <td>
                    <a href=\"";
            // line 24
...
{% endblock %}
", "comment/index.html.twig", "/Applications/MAMP/htdocs/iim-symfony/project/iim-project/templates/comment/index.html.twig");
    }
}

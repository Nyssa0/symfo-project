...
class __TwigTemplate_ea4202d703db84907941f7b2a1486e4cd1d54cc3bb024f9dfe14553813096e62 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            echo "</td>
                <td>";
            // line 20
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["category"], "CategoryName", [], "any", false, false, false, 20), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 22
...
{% endblock %}
", "category/index.html.twig", "/Applications/MAMP/htdocs/iim-symfony/project/iim-project/templates/category/index.html.twig");
    }
}

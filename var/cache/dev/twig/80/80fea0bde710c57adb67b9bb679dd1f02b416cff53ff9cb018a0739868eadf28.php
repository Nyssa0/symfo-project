...
class __TwigTemplate_2c1ba284011098f18f08267989a87281cd544d745315a9f544295c65c60c742b extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 8
        echo twig_include($this->env, $context, "author/_form.html.twig", ["button_label" => "Update"]);
        echo "
...
{% block body %}
    ...
    {{ include('author/_form.html.twig', {'button_label': 'Update'}) }}

    <a href=\"{{ path('author_index') }}\">back to list</a>

    {{ include('author/_delete_form.html.twig') }}
{% endblock %}
", "author/edit.html.twig", "/Applications/MAMP/htdocs/iim-symfony/project/iim-project/templates/author/edit.html.twig");
    }
}

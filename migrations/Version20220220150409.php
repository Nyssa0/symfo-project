 ...
 */
final class Version20220220150409 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category DROP category_id, CHANGE cat_name category_name VARCHAR(255) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE category ADD category_id INT DEFAULT NULL, ADD cat_name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP category_name');
